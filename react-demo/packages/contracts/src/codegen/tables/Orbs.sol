...
library Orbs {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Orbs", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004f726273000000000000000000000000);
